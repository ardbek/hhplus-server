...
import kr.hhplus.be.server.stub.mock.dto.request.MockReserveRequest;
...
public class MockSeatReservationController {
    ...
    @PostMapping
    public ResponseEntity<ReserveResponse> reserve(@RequestBody MockReserveRequest request) {
